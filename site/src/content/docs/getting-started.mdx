...
- Read the [Core Concepts](/gatehouse/docs/concepts/) to understand proxy mode, dynamic secrets, and pattern learning.
- Set up [Authentication](/gatehouse/docs/authentication/) with user accounts, AppRoles for agents, and optional TOTP.
- Browse the [Web UI tour](/gatehouse/docs/web-ui/) to see what each panel does.
